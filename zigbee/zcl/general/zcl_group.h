...
status_t zcl_rd_sw(u8 srcEp, epInfo_t *pDstEpInfo, u8 disableDefaultRsp, u8 seqNo, u16 len,u8 *par);
#define zcl_rd_sw_Cmd(a,b,c,d,e)		(zcl_rd_sw((a), (b), (c), ZCL_SEQ_NUM, (d), (e)))
/**
