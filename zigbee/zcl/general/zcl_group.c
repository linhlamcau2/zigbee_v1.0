...
_CODE_ZCL_ status_t zcl_rd_sw(u8 srcEp, epInfo_t *pDstEpInfo, u8 disableDefaultRsp, u8 seqNo,u16 len,u8 *par)
{
	return zcl_sendCmd(srcEp, pDstEpInfo, ZCL_CLUSTER_RD_NEMA, 0x01, TRUE,
					ZCL_FRAME_CLIENT_SERVER_DIR, disableDefaultRsp, 0, seqNo, len, par);
}
