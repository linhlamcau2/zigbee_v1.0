...
{
	return zcl_registerCluster(endpoint, ZCL_CLUSTER_RD_SW, manuCode, arrtNum, attrTbl, zcl_rd_sw_cmdHandler, cb);
}
...
const zcl_specClusterInfo_t g_rd_sw_ClusterList[] =
{
	...
	#endif
	#ifdef ZCL_ON_OFF
		{ZCL_CLUSTER_RD_SW,			 MANUFACTURER_CODE_NONE, 	ZCL_RD_SW_ATTR_NUM,		rd_sw_attrTbl,			zcl_rd_sw_register,			 zcl_rd_sw_Cb},
	#endif
};
